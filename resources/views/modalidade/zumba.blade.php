...
@section('conteudo')
{{-- Tudo que terá na página de Zumba --}}
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcumb-content">
                            <h1 class="breadcumb-title">Zumba Detalhes</h1>
                    ...
                    <div class="col-xxl-8 col-lg-7">
                        <div class="service-page-single">
                            ...
                            <div class="page-content">
                                ...
                                <p>Como acontece as aulas de Zumba?</p>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="service-wrap">
                                            <h6><i class="far fa-check me-2"></i> Escolha das aula</h6>
